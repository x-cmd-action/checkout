...
| Wall-clock step duration (warm, depth: 1) | 529–675 ms | 261–524 ms (~1.3–2.0x faster after baseline-subtraction; measured by [`benchmark-vs-actions-checkout`](.github/workflows/benchmark.yml)) |
